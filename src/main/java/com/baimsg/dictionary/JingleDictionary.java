 ...
 **/
public class JingleDictionary implements DictionarySuper {
    private final User user;
    private static final HashMap<String, String> headers = new HashMap<>();

    public JingleDictionary(User user) {
        this.user = user;
    }
    ...
    static {
        ...
        headers.put("Host", "124.71.84.178:6688");
    }
    ...
    public User login() {
        try {
            ...
            JSONObject res = new JSONObject(HttpUtils.build().
                    exePost("http://124.71.84.178:6688/auth/login/userName",
                            JSON_RES.toString(),
                            headers
                    ));
